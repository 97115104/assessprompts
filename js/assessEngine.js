...
- "optimized_version": A complete, production-ready rewritten version of the prompt with all your suggestions applied. Preserve the original intent completely. CRITICAL FORMATTING RULE: Write this as natural plain text only. NO markdown syntax of any kind — NO hashtags or heading symbols (#, ##), NO bullet symbols (*, -), NO bold or italic markers (**, __, *, _), NO code fences, NO angle brackets for formatting. Use regular paragraphs separated by line breaks, numbered lists with "1. 2. 3." format, and clear paragraph breaks for structure. This is the same format as a clean document someone would paste into any chat interface. The optimized version must be comprehensive, specific, and fully self-contained — a third party reading it should understand the task without any additional context. It must address every identified issue and missing element. The quality of this optimized version must be high enough that if it were independently assessed by this same tool, it would earn a grade of B+ or better.
